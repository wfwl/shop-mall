...
var _cities = require('utils/cities/index.js');
var _address = require('service/address-service.js');
var templateAddressModal = require('./addressModal.string');
...
//     // 提交收货地址
//     this.$modalWrap.find('.address-btn').click(function(){
//       var receiverInfo = _this.getReceiverInfo(), isUpdate = _this.option.isUpdate
//       if (!isUpdate && receiverInfo.status) {
//         // 使用新地址
//         _address.save(receiverInfo.data, function(res){
//           _mm.successTips('地址添加成功')
...
//   // 加载市
//   loadCity: function(provinceName) {
//     var cities  = _cities.getCities(provinceName)|| [], $citySelect = this.$modalWrap.find('#receiver-city')
//     $citySelect.html(this.getSelectOption(cities))
//      // 更新地址 城市回填
//     if (this.option.isUpdate && this.option.data.receiverCity) {
//       $citySelect.val(this.option.data.receiverCity)
